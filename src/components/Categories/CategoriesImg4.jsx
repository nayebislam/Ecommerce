...
const CategoriesImg4 = () => {
  return (
    ...
    >
      <g clip-path="url(#clip0_12026_2101)">
        <path
          ...
          className="group-hover:stroke-white ease-in-out duration-200"
        />
        <path
