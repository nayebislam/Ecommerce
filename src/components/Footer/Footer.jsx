...
const Footer = () => {
  return (
    <section className="pt-[80px] pb-[60px] bg-black">
      <Containar>
        <div className="flex justify-between">
          <div className="flex flex-col">
            ...
            <div className="mt-4 relative">
              ...
              />
              <AiOutlineSend size={24} color="white" className="absolute top-3 right-[15px]" />
            </div>
          </div>
          <div>
            <ul className="flex flex-col gap-y-4">
                <h3 className="font-primary font-medium text-[20px] leading-7 text-white mb-2">Support</h3>
          ...
          <div>
            <ul className="flex flex-col gap-y-4">
                <h3 className="font-primary font-medium text-[20px] leading-7 text-white mb-2">Account</h3>
                <li className="font-primary text-[16px] leading-6 text-white max-w-[175px]">
                    <a href="#">My Account</a>
                </li>
                <li className="font-primary text-[16px] leading-6 text-white">
          ...
          <div>
            <ul className="flex flex-col gap-y-4">
                <h3 className="font-primary font-medium text-[20px] leading-7 text-white mb-2">Quick Link</h3>
                <li className="font-primary text-[16px] leading-6 text-white max-w-[175px]">
          ...
          <div>
            <h3 className="font-primary font-medium text-[20px] leading-7 text-white">Download App</h3>
            <p className="font-primary font-medium text-[12px] leading-[18px] text-white mt-6 mb-2">Save $3 with App New User Only</p>
            <div className="flex items-center gap-x-[11px]">
                <img src={qrcode} alt="#qrcode" className="cursor-pointer" />
                <div>
                    <img src={playstore} alt="#playstore" className="mb-[9px] cursor-pointer" />
